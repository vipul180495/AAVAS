...
export const ClientLogin = (props) => {
    ...
    useEffect(() => {
        const welcomeSpeech = new SpeechSynthesisUtterance(
          "You are on client login page. Please enter your email and postcode to log into your account"
        );
...
//   useEffect(() => {
//     const welcomeSpeech = new SpeechSynthesisUtterance(
//       "You are on the client login page. Please enter your email and postcode to log into your account."
//     );
//     window.speechSynthesis.speak(welcomeSpeech);
...
//             {isRecording && <div>Recording...</div>}
//             {speechText && <div>Speech to text: {speechText}</div>}
