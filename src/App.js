...
//       <Header isLoggedIn={isLoggedIn} onFormSwitch={toggleForm} />
//       {
//         currentForm === "Login" ? <Login onFormSwitch={toggleForm} /> :
//           currentForm === "ClientLogin" ? <ClientLogin onFormSwitch={toggleForm} /> :
//             currentForm === "ClientRegister" ? <ClientRegister onFormSwitch={toggleForm} /> :
//               currentForm === "OwnerLogin" ? <OwnerLogin onFormSwitch={toggleForm} /> :
//                 currentForm === "OwnerRegister" ? <OwnerRegister onFormSwitch={toggleForm} /> :
//                   currentForm === "AdminLogin" ? <AdminLogin onFormSwitch={toggleForm} /> :
//                     currentForm === "ViewProperty" ? <ViewProperty onFormSwitch={toggleForm} /> :
//                       currentForm === "ReviewViewing" ? <ReviewViewing onFormSwitch={toggleForm} /> :
//                         currentForm === "CreateBooking" ? <CreateBooking onFormSwitch={toggleForm} /> :
